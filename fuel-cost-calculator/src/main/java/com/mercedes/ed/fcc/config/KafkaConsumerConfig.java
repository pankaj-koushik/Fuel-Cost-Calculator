...
public class KafkaConsumerConfig {
    ...
    @Bean
    public <T extends AbstractEvent> ConsumerFactory<String, T> consumerFactory() {
    ...
    @Bean
    public  <T extends AbstractEvent> ConcurrentKafkaListenerContainerFactory<String, T>
